...
var s_ico = document.getElementById('s_ico');
s_bot.onclick = function () {
    s_ico.style.top = '-400px';
...
s_gj.onclick = function () {
    s_ying.style.backgroundImage = 'url(./images/srj_images/2.png)';
...
s_fh.onclick = function () {
    s_ying.style.backgroundImage = 'url(./images/srj_images/35.png)';
...
s_jk.onclick = function () {
    s_ying.style.backgroundImage = 'url(./images/srj_images/36.png)';
    s_a.style.display = 'none';
    s_b.style.display = 'none';
    s_d.style.display = 'none';
    s_e.style.display = 'none';
...
s_xf.onclick = function () {
    s_ying.style.backgroundImage = 'url(./images/srj_images/37.png)';
    s_a.style.display = 'none';
    s_b.style.display = 'none';
    s_c.style.display = 'none';
    s_e.style.display = 'none';
...
s_hn.onclick = function () {
    s_ying.style.backgroundImage = 'url(./images/srj_images/38.png)';
    s_a.style.display = 'none';
    s_b.style.display = 'none';
    s_c.style.display = 'none';
    s_d.style.display = 'none';
...
s_zb.onclick = function () {
    s_ying.style.backgroundImage = 'url(./images/srj_images/39.png)';
    s_a.style.display = 'none';
    s_b.style.display = 'none';
    s_c.style.display = 'none';
    s_e.style.display = 'none';
...
s_ld.onclick = function () {
    s_ying.style.backgroundImage = 'url(./images/srj_images/40.png)';
    s_a.style.display = 'none';
    s_b.style.display = 'none';
    s_c.style.display = 'none';
    s_e.style.display = 'none';
...
s_gl.onclick = function () {
    s_ying.style.backgroundImage = 'url(./images/srj_images/41.png)';
    s_a.style.display = 'none';
    s_b.style.display = 'none';
    s_c.style.display = 'none';
    s_e.style.display = 'none';
...
s_hk.onclick = function () {
    s_ying.style.backgroundImage = 'url(./images/srj_images/42.png)';
    s_a.style.display = 'none';
    s_b.style.display = 'none';
    s_c.style.display = 'none';
    s_e.style.display = 'none';
...
s_xl.onclick = function () {
    s_ying.style.backgroundImage = 'url(./images/srj_images/43.png)';
    s_a.style.display = 'none';
    s_b.style.display = 'none';
    s_c.style.display = 'none';
    s_e.style.display = 'none';
